...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 6:
			if (ch == L'c') {AddCh(); goto case_7;}
			else {goto case_0;}
		case 7:
			case_7:
			if (ch == L't') {AddCh(); goto case_8;}
			else {goto case_0;}
		case 8:
			case_8:
		...
		case 16:
			case_16:
			if (ch == L'n') {AddCh(); goto case_17;}
			else {goto case_0;}
		case 17:
			case_17:
			if (ch == L'g') {AddCh(); goto case_18;}
			else {goto case_0;}
		case 18:
			case_18:
			if (ch == L'l') {AddCh(); goto case_19;}
			else {goto case_0;}
		case 19:
			case_19:
		...
		case 20:
			...
			{t->kind = 3; break;}
		case 21:
			if (ch == L'q') {AddCh(); goto case_22;}
			else {goto case_0;}
		case 22:
			case_22:
			if (ch == L'u') {AddCh(); goto case_23;}
			else {goto case_0;}
		case 23:
			case_23:
		...
		case 29:
			case_29:
			if (ch == L'n') {AddCh(); goto case_30;}
			else {goto case_0;}
		case 30:
			case_30:
			if (ch == L't') {AddCh(); goto case_31;}
			else {goto case_0;}
		case 31:
			case_31:
			{t->kind = 5; break;}
		case 32:
			if (ch == L'r') {AddCh(); goto case_33;}
			else {goto case_0;}
		case 33:
			case_33:
			if (ch == L'e') {AddCh(); goto case_34;}
			else {goto case_0;}
		case 34:
			case_34:
			if (ch == L'a') {AddCh(); goto case_35;}
			else {goto case_0;}
		case 35:
			case_35:
			{t->kind = 6; break;}
		case 36:
			if (ch == L'e') {AddCh(); goto case_37;}
			else {goto case_0;}
		case 37:
			case_37:
		...
		case 38:
			case_38:
			if (ch == L't') {AddCh(); goto case_39;}
			else {goto case_0;}
		case 39:
			case_39:
			if (ch == L'e') {AddCh(); goto case_40;}
			else {goto case_0;}
		case 40:
			case_40:
			if (ch == L'r') {AddCh(); goto case_41;}
			else {goto case_0;}
		case 41:
			case_41:
			{t->kind = 7; break;}
		case 42:
			if (ch == L'e') {AddCh(); goto case_43;}
			else {goto case_0;}
		case 43:
			case_43:
			if (ch == L'm') {AddCh(); goto case_44;}
			else {goto case_0;}
		case 44:
			case_44:
			if (ch == L'o') {AddCh(); goto case_45;}
			else {goto case_0;}
		case 45:
			case_45:
			if (ch == L'v') {AddCh(); goto case_46;}
			else {goto case_0;}
		case 46:
			case_46:
			if (ch == L'e') {AddCh(); goto case_47;}
			else {goto case_0;}
		case 47:
			case_47:
			{t->kind = 8; break;}
		...
		case 51:
			case_51:
			if (ch == L'T') {AddCh(); goto case_52;}
			else {goto case_0;}
		case 52:
			case_52:
			{t->kind = 9; break;}
		case 53:
			if (ch == L'R') {AddCh(); goto case_54;}
			else {goto case_0;}
		case 54:
			case_54:
		...
		case 55:
			case_55:
			if (ch == L'A') {AddCh(); goto case_56;}
			else {goto case_0;}
		case 56:
			case_56:
			{t->kind = 10; break;}
		case 57:
			if (ch == L'E') {AddCh(); goto case_58;}
			else {goto case_0;}
		case 58:
			case_58:
			if (ch == L'N') {AddCh(); goto case_59;}
			else {goto case_0;}
		case 59:
			case_59:
			if (ch == L'T') {AddCh(); goto case_60;}
			else {goto case_0;}
		case 60:
			case_60:
		...
		case 62:
			...
			{t->kind = 11; break;}
		case 63:
			if (ch == L'U') {AddCh(); goto case_64;}
			else {goto case_0;}
		case 64:
			case_64:
			if (ch == L'M') {AddCh(); goto case_65;}
			else {goto case_0;}
		case 65:
			case_65:
			{t->kind = 12; break;}
