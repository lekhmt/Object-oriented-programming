...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 9:
			case_9:
			if (ch == L'i') {AddCh(); goto case_10;}
			else {goto case_0;}
		case 10:
			case_10:
			if (ch == L'n') {AddCh(); goto case_11;}
			else {goto case_0;}
		case 11:
			case_11:
			if (ch == L't') {AddCh(); goto case_12;}
			else {goto case_0;}
		case 12:
			case_12:
			{t->kind = 3; break;}
		case 13:
			if (ch == L'e') {AddCh(); goto case_14;}
			else {goto case_0;}
		case 14:
			case_14:
			if (ch == L't') {AddCh(); goto case_15;}
			else {goto case_0;}
		case 15:
			case_15:
			{t->kind = 4; break;}
		case 16:
			if (ch == L'o') {AddCh(); goto case_17;}
			else {goto case_0;}
		case 17:
			case_17:
			if (ch == L'p') {AddCh(); goto case_18;}
			else {goto case_0;}
		case 18:
			case_18:
			{t->kind = 5; break;}
		case 19:
			case_19:
			if (ch == L'p') {AddCh(); goto case_20;}
			else {goto case_0;}
		case 20:
			case_20:
			{t->kind = 6; break;}
		case 21:
			if (ch == L'n') {AddCh(); goto case_22;}
			else {goto case_0;}
		case 22:
			case_22:
			if (ch == L's') {AddCh(); goto case_23;}
			else {goto case_0;}
		case 23:
			case_23:
			if (ch == L'e') {AddCh(); goto case_24;}
			else {goto case_0;}
		case 24:
			case_24:
		...
		case 39:
			...
			{t->kind = 12; break;}
		case 40:
			if (ch == L'u') {AddCh(); goto case_6;}
			else if (ch == L'r') {AddCh(); goto case_9;}
			else if (ch == L'o') {AddCh(); goto case_19;}
			else {goto case_0;}
		case 41:
